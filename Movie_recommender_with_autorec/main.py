...
def learning (testData, testData_i, trainData, trainData_i, trainMask, trainMask_i, unratedItemsMask, positiveMask, negativeMask, numOfRatings, unrated_items, GroundTruth, GroundTruth_i, itemCount, m, h, reg, o, l):
    if m == "autorec":
        for p in problem:
            if p == "explicit":
        ...
        for ran in rankingparam:
            for a in alpha:
                for b in beta:
                    trainer.trainDAS(testData, trainData, trainData_i, trainMask, trainMask_i, unratedItemsMask, positiveMask, numOfRatings, unrated_items, GroundTruth, itemCount, topN, m, h, reg, o, l, ran, a, b)
    
    elif m == "bpr":
        p="implicit"
        trainer.trainBPR(testData, trainData, trainMask, unratedItemsMask, numOfRatings, unrated_items, GroundTruth, itemCount, topN, m, h, reg, o, l,p)
            ...
            for reg in regularization:
                for o in optimizerType:
                    for l in learningRate:
                        ...
                        # learn this model
                        learning(testData, testData_i, trainData, trainData_i, trainMask, trainMask_i, unratedItemsMask, positiveMask, negativeMask, numOfRatings, unrated_items, GroundTruth, GroundTruth_i, itemCount, m, h, reg, o, l)
